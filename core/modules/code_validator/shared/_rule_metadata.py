...
RULE_NAMES: Dict[str, str] = {
    ...
    "CSB012": "Event handler not unsubscribed",
    "CSB013": "Debug.Log outside #if UNITY_EDITOR",
    "CSB014": "Float literal without f suffix",
    "CSB015": "Empty destructor / finalizer",
    "CSB016": "Commented-out code block",
    # Security
    "CSS005": "Instantiate result not null-checked",
    "CSS006": "GetComponent result not null-checked",
    "CSS007": "Direct cast (as) result not null-checked",
    "CSS008": "Division without zero-check",
    "CSS009": "Collision object not null-checked",
    # Unity-specific
    "UN009": "Coroutine started but never stopped",
    "UN010": "Physics call inside Update",
    "UN011": "Transform modified in a loop",
    "UN013": "Missing RequireComponent attribute",
    "UN014": "DontDestroyOnLoad on non-singleton",
    ...
    "VSP003": "GetComponent node inside an Update graph",
    "VSP004": "Find node inside an Update graph",
    "VSP005": "Instantiate or Destroy node inside Update",
    "VSM001": "Visual Scripting graph too large",
    "VSM002": "Disconnected node in graph",
    "VSM003": "Graph has too many variable nodes",
    "VSM004": "State machine graph too large",
    "VSB001": "Orphan custom event",
    "VSB002": "Empty graph asset",
    "VSB003": "Deep flow chain in graph",
    "VSB004": "Graph responds to too many lifecycle events",
    "VSB005": "GetComponent node without null-check",
    "VSB006": "SendMessage / BroadcastMessage usage",
    "VSB007": "WaitForSeconds inside Update graph",
    "VSB008": "Script graph has no event root",
    "VSS001": "Hardcoded secret in graph literal",
    "VSS002": "Debug.Break node in graph",
    "VSS003": "PlayerPrefs.Set node in graph",
}
...
def _build_rule_id_to_function() -> Dict[str, Callable[..., Any]]:
    ...
    from code_validator.unreal.blueprint.blueprint_rules import (
    ...
    from code_validator.unreal.cpp.cpp_maintainability import (
    ...
    from code_validator.unreal.cpp.cpp_security import (
