...
RULE_TO_PATTERN = {
    ...
    "CB007": ("delete_line", None),
    "CB008": ("replace_text", (".0", ".0f")),
    "CB012": ("replace_text", ("(int)", "static_cast<int32>")),
    "CB013": ("null_check", "->"),
    "CB018": ("replace_text", ("std::array", "TArray")),
    "CB019": ("replace_text", ("~", "virtual ~")),
    "CB020": ("replace_text", ("FString Id", "FName Id")),
    "CB022": ("replace_text", ("ensure(", "ensureAlways(")),
    "CB023": ("replace_text", ("();", "() override;")),
    "CB030": ("replace_text", ('"', 'TEXT("')),
    # Security (CS)
    ...
    "CM008": ("replace_text", ("~Class() {}", "~Class() = default;")),
