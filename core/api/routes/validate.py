...
async def validate_assets(request: Request, payload: dict):
    """
    Validates asset naming conventions for a given list of asset paths.
...
async def validate_code(request: Request, payload: dict):
    """
    Analyzes code files or Blueprints for code smells and bad patterns.
